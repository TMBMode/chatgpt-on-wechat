            ...
            if not e_context.is_pass() and reply and reply.type:
                ...
                if reply.type == ReplyType.TEXT:
                    ...
                    if context.get("isgroup", False):
                        ...
                        reply_text = conf().get("group_chat_reply_prefix", "") + reply_text + conf().get("message_tail", "")
                    else:
                        reply_text = conf().get("single_chat_reply_prefix", "") + reply_text + conf().get("message_tail", "")
